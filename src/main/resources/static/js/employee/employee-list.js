$(document).ready(function () {
    ...
    empStatus.on('change', (e) => {
        let clickTarget = $(e.currentTarget).val();
        let empId = $(e.currentTarget).data('id');

        console.log("empStatus : " + clickTarget);
        console.log("empId : " + empId);

        $.ajax({
            url: "/member/update/st",
            data: {
                "empStatus": clickTarget,
                "id": empId
            },
            type: "post",
